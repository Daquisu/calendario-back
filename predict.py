...
for hashtag_label in ['#coleraalegria_eleicoes', '#desenhospelademocracia_eleicoes', '#designativista_eleicoes', '#mariellepresente_eleicoes', '#elenao_eleicoes']:
    ...
    for img in range(len(y_pred)):
        ...
        os.system('mv /home/daquisu/projects/calendario-back/*' + hashtag_label[1:] + '/' + arr[image_index_list[img]][:-6] + '*' + ' /home/daquisu/projects/calendario-back/' + hashtag_label + '/' + cat + '/')
